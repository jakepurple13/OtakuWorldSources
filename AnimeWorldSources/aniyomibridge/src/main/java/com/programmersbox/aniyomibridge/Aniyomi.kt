...
object Aniyomi : ExternalApiServicesCatalog {
    ...
    override fun getSources(): List<SourceInformation> = listOf(
        ...
        SourceInformation(
            apiService = object : ApiService {
                ...
                override val serviceName: String get() = "Aniyomi Bridge"
                override val notWorking: Boolean get() = true
            },
            name = "Aniyomi Bridge",
            icon = null,
            packageName = "com.programmersbox.aniyomibridge",
            catalog = this
        ),
    ...
    override val name: String get() = "Aniyomi Bridge"

    override fun shouldReload(packageName: String, packageInfo: PackageInfo): Boolean {
        return packageInfo.reqFeatures?.any { it.name == "tachiyomi.animeextension" } == true
    }
