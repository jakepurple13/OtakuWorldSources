...
class NetworkPreferences(
    ...
    // Mirrors real Mihon/Aniyomi: use the device's actual WebView/Chrome user agent instead of
    // a hardcoded string that inevitably goes stale and can trigger UA-based anti-bot blocking
